...
export default function Dashboard() {
  ...
  const userName = 'Arjun'; // logged-in user name
  ...
  const metricBars = [
    ...
    { label: 'Revenue potential', score: 88, color: '#3B82F6' },
      ...
      <main className="dashboard-main fade-in">
        ...
        <section className="metrics-row">
          <div className="metric-card">
            ...
            <div className="metric-value blue-text">82</div>
            <span className="metric-subtext positive">+4 since last edit</span>
          </div>
          <div className="metric-card">
        ...
        <div className="submit-modal-overlay" onClick={closeModal}>
          <div className="submit-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="submit-modal-body">
              <p className="submit-modal-subtitle">Upload your pitch deck — it will be watermarked with your name.</p>
